...
(function($){
    $.categoryDropdown = function(el, options){
        ...
        base.init = function(){
            ...
            $(base.dropdown).click(function(event){
                ...
                flUtil.setPriorityZIndex(base.container);
            });
    ...
    $.categoryDropdown.defaults = {
        ...
        typesData: [],
        phrases: {},
        interfaceDom: '<div class="cd-extendable priority-z-index"><div class="dropdown"></div><div class="box "><div class="bc"></div><div class="uls"></div></div></div>',
