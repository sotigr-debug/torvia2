        ...
        <div class="submit-cell">
            ...
            {elseif $field.Type == 'phone'}
                <div class="gap-2 d-flex align-items-md-center flex-column flex-md-row">
                    <input class="phone-field-valid" type="hidden" name="account[{$field.Key}][valid]" value="0" />
                    <input class="phone-field-number" type="hidden" name="account[{$field.Key}][number]" value="{$fVal.$fKey.number}" />
                    <input class="phone-field"
                           type="text"
                           name="account[{$field.Key}][template]"
                            ...
                            <span class="custom-input d-block phone-messengers__whatsapp">
                                <label title="{$lang.profile_has_whatsapp}">
                                    <input type="checkbox"
                                           ...
                                           name="account[{$field.Key}][messengers][whatsapp]"
                                    />
                            ...
                            <span class="custom-input d-block mt-2 phone-messengers__viber">
                                <label title="{$lang.profile_has_viber}">
                                    <input type="checkbox"
                                           ...
                                           name="account[{$field.Key}][messengers][viber]"
                                    />
                            ...
                            <span class="custom-input d-block mt-2 phone-messengers__telegram">
                                <label title="{$lang.profile_has_telegram}">
                                    <input type="checkbox"
                                           ...
                                           name="account[{$field.Key}][messengers][telegram]"
                                    />
