...
<form name="contact_owner"
      ...
      action="">
    {if $isLogin}
        <div class="submit-cell flex-column">
            <textarea class="mb-2" {if $allow_send_message}id="contact_owner_message_{$captcha_box_id}" name="contact_message"{/if} rows="{if $allow_send_message}6{else}4{/if}" placeholder="{$lang.message}" cols=""></textarea>
        </div>
