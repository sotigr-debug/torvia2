...
<form method="{$listing_type.Submit_method}" action="{if $pageInfo.Controller == 'my_listings'}{pageUrl key=$pageInfo.Key add_url=$search_results_url}{/if}">
	...
	<div class="search-footer clearfix">
		...
		<div class="align-button"><input class="search_field_item button w-100" type="submit" name="search" value="{$lang.search}" /></div>
	</div>
</form>	
