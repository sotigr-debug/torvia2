...
{elseif $block.Key|strpos:'ltsb_' === 0 || $block.Key|strpos:'ltma_' === 0 || $block.Key|strpos:'ltpb_' === 0}
...
{elseif $block.Key == 'account_alphabetic_filter'}
	{assign var='block_class' value='light-inputs stick'}
{elseif $block.Key == 'account_search'}
	{assign var='block_class' value='light-inputs side_block_search stick'}
...
{elseif $block.Key == 'account_page_location'}
	{assign var='block_class' value='account-location light-inputs stick'}
...
{else}
    {assign var='block_class' value=$block_class|cat:' '|cat:$block.Key}
{/if}

{if $block.Type == 'html'}
    {assign var='block_class' value=$block_class|cat:' html-block'}
{/if}
...
{rlHook name='tplBlocksManagerContentBottom'}
