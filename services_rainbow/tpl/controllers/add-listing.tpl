...
<head>
    ...
    <title>Projekt erstellen - Torvia</title>
    <meta name="description" content="Erstellen Sie ein neues Bauprojekt auf Torvia. Finden Sie qualifizierte und verifizierte Nachunternehmer für Ihre Bauvorhaben mit unserem intelligenten Matching-System.">
                ...
                <div class="hidden md:flex items-center space-x-4">
                    <div class="relative">
                        ...
                        <div id="userMenu" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-elevated border border-gray-200 py-2">
                            <a href="contractor_project_management_dashboard.html" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Projekt Dashboard</a>
                            <a href="project_posting_interface.html" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 font-medium">Projekt erstellen</a>
                            <a href="javascript:void(0)" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Unternehmensprofil</a>
                            <div class="border-t border-gray-100 my-2"></div>
                            <a href="homepage.html" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Abmelden</a>
                        </div>
                    </div>
                </div>
            ...
            <div id="mobileMenu" class="hidden md:hidden py-4 border-t border-gray-100">
                <div class="flex flex-col space-y-4">
                    ...
                    <div class="flex flex-col space-y-2 pt-4 border-t border-gray-100">
                        <a href="contractor_project_management_dashboard.html" class="text-gray-700 hover:text-primary transition-colors">Projekt Dashboard</a>
                        <a href="homepage.html" class="text-gray-700 hover:text-primary transition-colors">Abmelden</a>
                    </div>
                </div>
            </div>
        </nav>
    ...
    <main class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center space-x-4 mb-4">
                <a href="contractor_project_management_dashboard.html" class="text-primary hover:text-primary-700 flex items-center space-x-2">
