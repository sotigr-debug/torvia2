...
<head>
    ...
    <title>Construction News Center - Branchennews und Updates | Torvia</title>
    <meta name="description" content="Aktuelle Branchennews, Markttrends und Plattform-Updates für deutsche Bauprofis. Bleiben Sie informiert über Entwicklungen im Bausektor.">
    ...
    <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <a href="ratgeber_construction_guide_hub.html" class="text-gray-700 hover:text-primary transition-colors">Ratgeber</a>
                <a href="construction_news_center.html" class="text-primary font-semibold">News</a>
...
<section class="py-16 bg-gradient-to-r from-primary to-secondary">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="ratgeber_construction_guide_hub.html" class="bg-transparent border-2 border-white text-white hover:bg-white hover:text-primary text-lg px-8 py-4 rounded-lg font-semibold transition-all duration-300">
                Ratgeber entdecken
            </a>
        </div>
    </div>
