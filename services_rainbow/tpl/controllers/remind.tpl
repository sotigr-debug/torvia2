...
<div class="content-padding">
    {if $change}
        ...
        <form action="{pageUrl key='remind' vars="hash=`$smarty.get.hash`"}" class="mt-4" method="post">
                ...
                <div class="field single-field two-inline left">
                    <div>
                        <input id="new_password"
                            ...
                            maxlength="50"
                            {if $smarty.post.profile.password}value="{$smarty.post.profile.password}"{/if}
                        />
                    </div>
    ...
    {else}
        ...
        <form action="{pageUrl key='remind'}" method="post">
