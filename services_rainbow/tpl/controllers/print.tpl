...
<link href="{$rlTplBase}css/print.css?rev={$config.static_files_revision}" type="text/css" rel="stylesheet" />

<link type="image/x-icon" rel="shortcut icon" href="{$rlTplBase}img/favicon.ico?rev={$config.static_files_revision}" />
...
<script type="text/javascript" src="{$smarty.const.RL_LIBS_URL}jquery/cookie.js?rev={$config.static_files_revision}"></script>
<script type="text/javascript" src="{$rlTplBase}js/lib.js?rev={$config.static_files_revision}"></script>
...
<body{if $smarty.const.RL_LANG_DIR == 'rtl'} dir="rtl"{/if}>
	...
	<div class="header">
		<div class="two-inline left clearfix">
			<img src="{$rlTplBase}img/logo.{$logo_ext}?rev={$config.static_files_revision}" />
