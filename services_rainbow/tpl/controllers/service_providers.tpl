...
{rlHook name='service_providersTop'}
        ...
        <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="{$rlBase}provider_profiles.html" class="text-primary font-medium">Für Profis</a>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
                ...
                <div class="card hover:shadow-elevated cursor-pointer transition-all duration-300 group" onclick="openProviderModal('provider1')">
                    ...
                    <div class="flex space-x-2">
                        <button class="flex-1 btn-primary text-sm py-2" onclick="event.stopPropagation(); window.location.href="{$rlBase}booking_interface.html"">
                            Jetzt buchen
                        </button>
    ...
    <section class="py-16 bg-gradient-to-r from-primary to-secondary">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="{$rlBase}service_categories.html" class="bg-transparent border-2 border-white text-white hover:bg-white hover:text-primary text-lg px-8 py-4 rounded-lg font-semibold transition-all duration-300 inline-flex items-center justify-center space-x-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                    </svg>
                    ...
                    <div class="lg:col-span-1">
                        <div class="card-elevated sticky top-4">
                            ...
                            <div class="space-y-4 mb-6">
                                <button class="w-full btn-primary py-3" onclick="window.location.href="{$rlBase}booking_interface.html"">
                                    Jetzt buchen
                                </button>
...
{rlHook name='service_providersBottomTpl'}
