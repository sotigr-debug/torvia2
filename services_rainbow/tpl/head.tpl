...
<meta name="generator" content="Torvia - Neue Wege für Aufträge und Unternehmer." />
<meta charset="UTF-8" />
...
<script src="{$rlTplBase}js/lib.js?rev={$config.static_files_revision}"></script>
